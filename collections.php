...
<?php foreach($characters as $character): ?>
    ...
    <?php if($character['unlocked']): ?>
        ...
        <div class="w-full col-span-1 border-2 p-4 relative rounded-none flex flex-col justify-between overflow-hidden group transition-all duration-300 hover:-translate-y-2 z-10">
            ...
            <div class="flex flex-col gap-1 p-2">
                <h2 class="font-heading font-black text-base text-white uppercase tracking-tight text-red-600 truncate border-b  pb-1"><?=$character['name'] ?></h2>
            </div>
        </div>
    <?php else: ?>

<div class="col-span-1  border-2  p-4 relative rounded-none flex flex-col justify-between overflow-hidden group transition-all duration-300 hover:-translate-y-2 z-10 ">
    <figure class="w-full h-48  border  flex items-center justify-center overflow-hidden transform -skew-x-3 mb-4 shrink-0 relative">
        <img
