...
<head>
    ...
    <meta http-equiv="X-UA-Compatible"
          content="ie=edge">
    <title>DANGANRONPA // SUSPECT FILES</title>
    ...
    <style>
        /* Gritty dynamic background layout with scanline filters */
        .dangan-bg-grid {
        ...
        .dangan-bg-grid::after {
            content: "DATABASE // CHARACTER FILES";
            position: fixed;
            bottom: 2rem;
            left: 2rem;
        ...
        html::after {
            content: "INDEX: CHARACTER_UNLOCKS";
            position: fixed;
            top: 2rem;
            right: 2rem;
            font-family: 'Share Tech Mono', monospace;
        ...
        /* Caution stripe styling for the progress indicator */
        .dangan-progress-bar {
...
<body class="bg-dangan-slate text-white min-h-screen dangan-bg-grid font-sans selection:bg-dangan-pink selection:text-dangan-black grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 pt-24 md:pt-32 pb-12 px-4 md:px-8 max-w-7xl mx-auto items-start relative overflow-x-hidden">
...
<div class="col-span-full lg:col-span-3 progress-card p-5 bg-dangan-black/90 border-2 border-dangan-pink rounded-none dangan-neon-shadow flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
    ...
    <div class="w-full md:max-w-md bg-dangan-slate border border-dangan-pink/20 h-4 rounded-none mt-2 md:mt-0 relative overflow-hidden">
        ...
        ?>
        <div class="dangan-progress-bar h-full transition-all duration-500 rounded-none" style="width: <?= $percentage ?>%"></div>
    </div>
</div>
