            ...
            <tr class="border-3 divide-x-3">
                ...
                <td data-label="Actions" class="px-4 py-4 text-center bg-white align-middle">
                    <form method="post" action="" onsubmit="return confirm('Delete this user?');">
                        ...
                        <button type="submit" name="delete" class="group cursor-pointer inline-block outline-none transition-transform duration-200 hover:scale-110" title="Delete user">
                            <!-- SVG icon -->
